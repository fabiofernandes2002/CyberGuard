      ...
      <View>
        ...
        <View style={Styles.text}>
          <Text style={Styles.text}>
            Antes de acederes à CyberGuard, vamos ajustar a tua experiência.
            Responde a um breve questionário para avaliar as tuas capacidades e
            que cursos deves frequentar. Vamos lá!
          </Text>
        </View>
