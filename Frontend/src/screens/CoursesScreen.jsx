                ...
                <SafeAreaView>
                    ...
                    <View style={Styles.container2}>
                        ...
                        <Text style={Styles.textDescription}>
                            A privacidade de dados é crucial para assegurar que as tuas informações pessoais
                            permanecem seguras ao longo do processo.
                        </Text>
                        <View style={Styles.cards}>
                            {courses.map((course, index) => (
                                <Card key={index} style={Styles.card} onPress={() => handleCourseDetailsScreen(course)}>
                                    ...
                                    <Card.Content>
                                        ...
                                        <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 10 }}>
                                            {[...Array(5)].map((_, i) => <Star key={i} width={15} height={15} />)}
                                            <Text style={{ fontFamily: 'Supply-Medium', fontSize: 15, color: '#f7f7f7', marginLeft: 5 }}>({course.rating})</Text>
                                        </View>
                                    </Card.Content>
                                </Card>
                            ))}
